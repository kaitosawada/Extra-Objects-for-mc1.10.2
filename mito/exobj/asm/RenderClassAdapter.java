	...
	public static class MethodAdapter extends MethodVisitor {
		...
		public void visitInsn(int opcode) {
			if (opcode == RETURN) {
				...
				super.visitMethodInsn(INVOKESTATIC, "com/mito/exobj/BraceBase/BB_RenderHandler", "onRenderEntities", "(Lnet/minecraft/entity/Entity;Lnet/minecraft/client/renderer/culling/ICamera;F)V", false);
			}
			if (mv != null) {
				mv.visitInsn(opcode);
			}
